...
const ProvinceList = {
    ...
    AG: ['An Giang', 'Tỉnh An Giang'],
    BL: ['Bac Lieu', 'Tỉnh Bạc Liêu'], 
    BT: ['Ben Tre', 'Tỉnh Bến Tre'],
    CM: ['Ca Mau', 'Tỉnh Cà Mau'], 
    CT: ['Can Tho', 'Tỉnh Cần Thơ'], 
    DT: ['Dong Thap', 'Tỉnh Đồng Tháp'],
    HG: ['Hau Giang', 'Tỉnh Hậu Giang'],
    KG: ['Kien Giang', 'Tỉnh Kiên Giang'], 
    LA: ['Long An', 'Tỉnh Long An'],
    ST: ['Soc Trang', 'Tỉnh Sóc Trăng'],
    TG: ['Tien Giang', 'Tỉnh Tiền Giang'],
    TV: ['Tra Vinh', 'Tỉnh Trà Vinh', 'Vĩnh Long'],
    VL: ['Vinh Long', 'Tỉnh Vĩnh Long', 'Vĩnh Long'],

    // Dong Nam Bo
    HCM: ['Ho Chi Minh', 'Hồ Chí Minh'],
    BD: ['Binh Duong', 'Bình Dương'],
    BP: ['Binh Phuoc', 'Bình Phước'],
    BRVT: ['Ba Ria - Vung Tau', 'Bà Rịa - Vũng Tàu'],
    DN: ['Dong Nai', 'Đồng Nai'],
    TN: ['Tay Ninh', 'Tây Ninh'],

    // Dong Bac Bo
    BG: ['Bac Giang', 'Bắc Giang'],
    QN: ['Quang Ninh', 'Quảng Ninh'],
    TN: ['Thai Nguyen', 'Thái Nguyên'],
    PT: ['Phu Tho', 'Phú Thọ']
}
...
const DistrictList = {
    ...
    // Dong Bang Song Cuu Long
    // Ca Mau
    CM_1: ['Cai Nuoc', 'Cái Nước'], 
    CM_2: ['Dam Doi', 'Đầm Dơi'],
    CM_3: ['Nam Can', 'Năm Căn'],
    CM_4: ['Ngoc Hien', 'Ngọc Hiển'],
    CM_5: ['Phu Tan', 'Phú Tân'],
    CM_6: ['Thoi Binh', 'Thời Bình'],
    CM_7: ['Tp Ca Mau', 'Thành phố Cà Mau', 'Tp. Cà Mau'],
    CM_8: ['Tran Van Thoi', 'Trần Văn Thời', 'huyện Trần Văn Thời'],
    CM_9: ['U Minh'],
    // An Giang
    AG_1: ['An Phu', 'An Phú'],
    AG_2: ['Chau Doc', 'Châu Đốc'], 
    AG_3: ['Chau Phu', 'Châu Phú'],
    AG_4: ['Chau Thanh', 'Châu Thành'],
    AG_5: ['Cho Moi', 'Chợ Mới'], 
    AG_6: ['Long Xuyen', 'Long Xuyên'],
    AG_7: ['Phu Tan', 'Phú Tân'],
    AG_8: ['Tan Chau', 'Tân Châu'],
    AG_9: ['Thoai Son', 'Thoại Sơn'],
    AG_10: ['Tinh Bien', 'Tịnh Biên'],
    AG_11: ['Tri Ton', 'Tri Tôn'],
    // Soc Trang
    ST_1: ['Chau Thanh', 'Châu Thành'],
    ST_2: ['Cu Lao Dung', 'Cù Lao Dung'],
    ST_3: ['Ke Sach', 'Kế Sách'],
    ST_4: ['Long Phu', 'Long Phú'],
    ST_5: ['My Tu', 'Mỹ Tú'],
    ST_6: ['My Xuyen', 'Mỹ Xuyên'],
    ST_7: ['Nga Nam', 'Ngã Năm'],
    ST_8: ['Soc Trang', 'Sóc Trăng'],
    ST_9: ['Thanh Tri'],
    ST_10: ['Tran De', 'Trần Đề'],
    ST_11: ['Vinh Chau', 'Vĩnh Châu'],
    // Kien Giang
    KG_1:['An Bien', 'An Biên'],
    KG_2:['An Minh', 'An Minh'],
    KG_3:['Chau Thanh', 'Châu Thành'],
    KG_4:['Giang Thanh'],
    KG_6:['Giong Rieng'],
    KG_7:['Go Quao'],
    KG_8:['Ha Tien'],
